...
final class KeyboardShortcutService {
    ...
    private var handler: ((FocusMode) -> Void)?

    // Shortcuts: Ctrl+Opt+Cmd + D/S/P/O
    private static let shortcuts: [(mode: FocusMode, keyCode: UInt32, modifiers: UInt32)] = [
    ...
    func register(handler: @escaping (FocusMode) -> Void) {
